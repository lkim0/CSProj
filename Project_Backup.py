        ...
        if outputSheet["A"+str(value)].internal_value == studentName:
            ...
            if outputSheet["C"+str(value)].internal_value == date:
                if remarks == "T" or remarks == "t":
                    ...
                    break
                elif remarks == "A" or remarks == "a" or remarks == "C" or remarks == "c":
                    if outputSheet["E"+str(value)].internal_value  == None:
                        cuttingClasses = 1
                    else:
            ...
            if remarks == "T" or remarks == "t":
                ...
                outputSheet['D'+str(maxim+1)]=0
            if remarks == "A" or remarks == "a" or remarks == "C" or remarks == "c":
                outputSheet['E'+str(maxim+1)]=1
            else:
                outputSheet['E'+str(maxim+1)]=0

#for iCC in range(2, len(outputSheet['E'])+1):
#    list[[1,2],[3,4]]
book.save('Output - Summary of Attendance(1).xlsx')
book.close()
inputFile.close()
